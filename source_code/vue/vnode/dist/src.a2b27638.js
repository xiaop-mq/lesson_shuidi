...
function h(tag) {
  ...
  // 结点类型提前判断
  var flags = null; // 标记，什么类型的节点

  return {
    // VNode
    // 代码更加精致
    _isVNode: true,
    // 架构vue的过程，就是实现vnode的过程
    flags: flags // diff算法优化 没有他也可以很好的实现，但是会多很多垃圾的，重复
...
// 虚拟结点 ——> 真实DOM h
// 返回结果是VNode
var elementVNode = (0, _h.h)('div', // tag  html tag
{
  style: {
    height: '100px',
    width: '100px',
  ...
  target: '#portal-box'
}, [(0, _h.h)('span', null, '我是标题1....'), (0, _h.h)('span', null, '我是标题2....')])); //   render(elementVNode, document.getElementById('app'))
