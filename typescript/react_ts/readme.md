...
- <{}> 这个是什么？怎么理解？
  1. App AppRouter 引入的路由根组件， 一定要进行类型定义  只需简单的输出HTML 使用StatelessComponebt
  2. React.StatelessComponent<{}>  type 声明的类型 定义文件 node_modules/@types/index.t.d   在这里可以找到类型定义